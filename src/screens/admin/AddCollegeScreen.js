  ...
  async function onSubmit() {
    ...
    try {
      ...
      if (Platform.OS === "web") {
        ...
        Alert.alert("Success", "College Added Successfully", [{ text: "OK", onPress: () => goBack() }]);
      }
    } catch (err) {
      ...
      <KeyboardAvoidingView style={{ flex: 1 }} behavior={Platform.OS === 'ios' ? 'padding' : undefined}>
        <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
          <View style={[styles.card, { backgroundColor: isDark ? "#111c2d" : "#fff", borderColor: isDark ? "#1e3a5f" : "#e2e8f0" }]}>
            <Text style={[styles.cardTitle, { color: isDark ? "#f1f5f9" : "#0f172a" }]}>Add New College</Text>
            <Text style={[styles.cardSubtitle, { color: isDark ? "#64748b" : "#94a3b8" }]}>Register a new educational partner</Text>
            ...
            <View style={styles.fieldGroup}>
              <Text style={[styles.label, { color: isDark ? "#94a3b8" : "#475569" }]}>COLLEGE NAME</Text>
              <TextInput
            ...
            <View style={styles.fieldGroup}>
              <Text style={[styles.label, { color: isDark ? "#94a3b8" : "#475569" }]}>EMAIL ADDRESS</Text>
              <TextInput
            ...
            <View style={styles.fieldGroup}>
              <Text style={[styles.label, { color: isDark ? "#94a3b8" : "#475569" }]}>ADDRESS</Text>
              <TextInput
            ...
            <View style={styles.fieldGroup}>
              <Text style={[styles.label, { color: isDark ? "#94a3b8" : "#475569" }]}>TEMPORARY PASSWORD</Text>
              <TextInput
            ...
            >
              {isSubmitting ? (
                ...
                <Text style={styles.submitBtnText}>Create College Profile</Text>
              )}
            </TouchableOpacity>
          </View>
        </ScrollView>
